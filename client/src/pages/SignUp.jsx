        ...
        <div className="flex justify-between items-center Roboto pt-20 sm:pt-32 sm:mx-20 mx-4 gap-2">
            ...
            <div className="ring-2 ring-rose-500/50 flex-1 p-6 rounded-lg ">
                ...
                <form action="">
                    ...
                    <button type='submit' className='bg-blue-500 text-white p-2 rounded-lg ml-2 hover:bg-blue-700 cursor-pointer w-25 focus:outline-2 duration-300 ease-in focus:outline-offset-2 focus:outline-blue-500'>Sign Up</button>
                </form>
